...
websearch_tool = AgentTool(agent=academic_websearch_agent)
websearch_tool.name = "tool_websearch"

newresearch_tool = AgentTool(agent=academic_newresearch_agent)
newresearch_tool.name = "tool_newresearch"
